...
import com.infusiblecoder.allinonevideodownloader.tiktok_methods.TikTokDownloadCloudBypassWebview_method_4;
...
Pinterest  https://pin.it/5DXC9Le
Allocine  https://www.allocine.fr/video/player_gen_cmedia=19599003&cfilm=234099.html
TODO not avaliable
dtube
veer.tv
     */
...
//                                    Looper.prepare();
                                            ...
                                            .getAsJSONObject(new JSONObjectRequestListener() {
                                                ...
                                                public void onResponse(JSONObject response) {
                                                    ...
                                                    try {
                                                        ...
                                                        JSONObject jsonObject1 = jsonObject.getJSONArray("aweme_list").getJSONObject(0);
                                                        username = jsonObject1.getJSONObject("author").getString("unique_id");


                                                        System.out.println("wojfdjhfdjh usrname " + username);

                                                        if (jsonObject1.has("image_post_info")) {

                                                            JSONArray jsonArray = jsonObject1.getJSONObject("image_post_info").getJSONArray("images");
                                                            for (int i = 0; i < jsonArray.length(); i++) {
                                                                String imgurl = jsonArray.getJSONObject(i).getJSONObject("display_image").getJSONArray("url_list").getString(1);
                                                                if (imgurl.contains("http")) {
                                                                    System.out.println("wojfdjhfdjh imageurl " + imgurl);

                                                                    DownloadFileMain.startDownloading(context, imgurl, "Tiktok_" + username + "_" + System.currentTimeMillis(), ".jpg");
                                                            ...
                                                            matag = jsonObject1.getJSONObject("video").getJSONObject("play_addr").getJSONArray("url_list").getString(2);
                                                ...
                                                public void onError(ANError error) {
                                                    ...
                                                    AndroidNetworking.get("https://s6.youtube4kdownloader.com/ajax/getLinks.php?video=" + finalUrl2 + "&rand=USSPONNQMQLRROS")
                                                            .setPriority(Priority.MEDIUM)
            ...
            //
                ...
                LikeeVideoDownloader tikTokNewTestDownloader = new LikeeVideoDownloader(Mcontext, url);
                tikTokNewTestDownloader.DownloadVideo();
                    ...
                    try {
                        ...
                        if (finalUrl3[0].contains("likee.video/v/")) {
                            try {
                                ...
                                String line2 = myres.substring(myres.indexOf("post_id"), myres.indexOf("';"));
                                finalUrl3[0] = line2;
                                System.out.println("mylikeeefjhjfhjsdfsdhf 2= " + finalUrl3[0]);
                        ...
                        //
                        //
                        //                            AndroidNetworking.post("https://api.like-video.com/likee-activity-flow-micro/videoApi/getVideoInfo")
                        //                                    .addHeaders("User-Agent", "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/97.0.4692.71 Safari/537.36")
                        //                                    .addBodyParameter("postIds", v)
                        //                                    .setPriority(Priority.MEDIUM)
                        //                                    .build()
                        //                                    .getAsJSONObject(new JSONObjectRequestListener() {
                        //                                        @Override
                        ...
                        //
                        //
                        //                                            System.out.println("mylikeeefjhjfhjsdfsdhf " + response);
                        //                                            dismissMyDialog();
                        //
                        //                                        }
                        //
