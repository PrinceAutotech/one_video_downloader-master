/*
 * *
 *  * Created by Syed Usama Ahmad on 2/9/23, 10:58 PM
 *  * Copyright (c) 2023 . All rights reserved.
 *  * Last modified 2/8/23, 4:49 PM
 *
 */
        ...
        protected Boolean doInBackground(Void... voids) {
            ...
            try {
                Document doc = Jsoup.connect("https://www.getfvid.com/downloader")
                        .data("url", downlink)
                        .header("authority", "www.getfvid.com")
                ...
                Log.e("TextLink", atag);
                Log.e("TextLink a ", String.valueOf(doc.select("a")));
